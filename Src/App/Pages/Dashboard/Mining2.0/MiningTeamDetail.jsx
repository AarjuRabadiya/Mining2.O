...
class MiningTeamDetail extends React.PureComponent {
  ...
  componentDidMount = () => {
    this.setState({
      miningTeamDetails: this.props.miningTeamDetails,
    });
  };
  componentWillReceiveProps = (props) => {
    this.setState({
      miningTeamDetails: props.miningTeamDetails,
      openData: props.miningTeamDetails[3].all_user_miner_details,
    });
  };
  render = () => {
    let {
      ...
      <Container>
        {isOpen && (
          <ExpandLandDetails
            ...
            sucessMes={sucessMes}
            fetchMiningList={fetchMiningList}
          />
        )}
        {isOpenSubPanel && (
