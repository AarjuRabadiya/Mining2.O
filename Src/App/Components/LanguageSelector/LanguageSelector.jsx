...
const ButtonDistance = styled(Button)`
  background-color: ${variable.CheckboxBorder};
  color: ${variable.whiteColor};
  padding: 1rem;
`;

const FormRowDistance = styled.div`
  position: absolute;
  right: 0;
  top: 0;
  z-index: 9999;
...
export default class LanguageSelector extends React.Component {
  ...
  render = (props) => {
    const { languages, alignRight, assets, distance } = this.props;
    ...
    return (
      <Container>
        ...
        <FormRowDistance
          ...
          distance={distance}
        >
          <ButtonDistance onClick={() => this.props.history.push("/distance")}>
            Distance
          </ButtonDistance>
        </FormRowDistance>
